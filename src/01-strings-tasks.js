...
function removeFirstOccurrences(str, value) {
  ...
  const secondPart = str.slice(pos + valueLen);
...
function encodeToRot13(str) {
  ...
  const upperCaseROT13 = 'NOPQRSTUVWXYZABCDEFGHIJKLM'.split('');
...
// alert(encodeToRot13('Gb trg gb gur bgure fvqr!'))
...
// console.log(isString(new String('test').valueOf())) // => true ???
